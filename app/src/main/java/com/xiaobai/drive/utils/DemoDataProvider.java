...
public class DemoDataProvider {
     ...
     */
    @MemoryCache
    public static List<FileItemEntity> getEmptyFileItem() {
        List<FileItemEntity> list = new ArrayList<>();
        for (int i=0;i<10;i++){
            FileItemEntity fileItemEntity=new FileItemEntity();
            fileItemEntity.setFileName(i+"");
            fileItemEntity.setTips(i+"2");
            fileItemEntity.setImageSrc("sss");
